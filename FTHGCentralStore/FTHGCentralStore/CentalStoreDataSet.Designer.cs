...
namespace FTHGCentralStore {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("CentalStoreDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class CentalStoreDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected CentalStoreDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            CentalStoreDataSet cln = ((CentalStoreDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "CentalStoreDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/CentalStoreDataSet.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            CentalStoreDataSet ds = new CentalStoreDataSet();
        ...
        public partial class ordersDataTable : global::System.Data.TypedTableBase<ordersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ordersRow AddordersRow(int invoiceID, string category, string product, int quantity, string receiver, string date_added) {
            ...
            private void InitClass() {
                ...
                this.columndate_added.MaxLength = 50;
            }
        ...
        public partial class ordersRow : global::System.Data.DataRow {
            ...
            public string date_added {
                get {
                    return ((string)(this[this.tableorders.date_addedColumn]));
                }
                set {
...
namespace FTHGCentralStore.CentalStoreDataSetTableAdapters {
    ...
    public partial class ordersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[orders] WHERE (([id] = @Original_id) AND ([invoiceID] = @Original_invoiceID) AND ([category] = @Original_category) AND ([product] = @Original_product) AND ([quantity] = @Original_quantity) AND ([receiver] = @Original_receiver) AND ([date_added] = @Original_date_added))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_date_added", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "date_added", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[orders] ([invoiceID], [category], [product], [quantity], [receiver], [date_added]) VALUES (@invoiceID, @category, @product, @quantity, @receiver, @date_added);
SELECT id, invoiceID, category, product, quantity, receiver, date_added FROM orders WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@date_added", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "date_added", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[orders] SET [invoiceID] = @invoiceID, [category] = @category, [product] = @product, [quantity] = @quantity, [receiver] = @receiver, [date_added] = @date_added WHERE (([id] = @Original_id) AND ([invoiceID] = @Original_invoiceID) AND ([category] = @Original_category) AND ([product] = @Original_product) AND ([quantity] = @Original_quantity) AND ([receiver] = @Original_receiver) AND ([date_added] = @Original_date_added));
SELECT id, invoiceID, category, product, quantity, receiver, date_added FROM orders WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@date_added", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "date_added", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_date_added", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "date_added", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FTHGCentralStore.Properties.Settings.Default.centralConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, invoiceID, category, product, quantity, receiver, date_added FROM dbo." +
                "orders";
        ...
        public virtual int Fill(CentalStoreDataSet.ordersDataTable dataTable) {
        ...
        public virtual CentalStoreDataSet.ordersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CentalStoreDataSet.ordersDataTable dataTable = new CentalStoreDataSet.ordersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CentalStoreDataSet.ordersDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CentalStoreDataSet dataSet) {
        ...
        public virtual int Delete(int Original_id, int Original_invoiceID, string Original_category, string Original_product, int Original_quantity, string Original_receiver, string Original_date_added) {
            ...
            if ((Original_receiver == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_receiver));
            }
            if ((Original_date_added == null)) {
                throw new global::System.ArgumentNullException("Original_date_added");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_date_added));
            }
        ...
        public virtual int Insert(int invoiceID, string category, string product, int quantity, string receiver, string date_added) {
            ...
            if ((date_added == null)) {
                throw new global::System.ArgumentNullException("date_added");
            }
            else {
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(date_added));
            }
        ...
        public virtual int Update(int invoiceID, string category, string product, int quantity, string receiver, string date_added, int Original_id, int Original_invoiceID, string Original_category, string Original_product, int Original_quantity, string Original_receiver, string Original_date_added, int id) {
            ...
            if ((receiver == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(receiver));
            }
            if ((date_added == null)) {
                throw new global::System.ArgumentNullException("date_added");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(date_added));
            }
            ...
            if ((Original_receiver == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_receiver));
            }
            if ((Original_date_added == null)) {
                throw new global::System.ArgumentNullException("Original_date_added");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_date_added));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int invoiceID, string category, string product, int quantity, string receiver, string date_added, int Original_id, int Original_invoiceID, string Original_category, string Original_product, int Original_quantity, string Original_receiver, string Original_date_added) {
            return this.Update(invoiceID, category, product, quantity, receiver, date_added, Original_id, Original_invoiceID, Original_category, Original_product, Original_quantity, Original_receiver, Original_date_added, Original_id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(CentalStoreDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._ordersTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(CentalStoreDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._ordersTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(CentalStoreDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._ordersTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(CentalStoreDataSet dataSet) {
            if ((dataSet == null)) {
